...
# Best when used with FiraCode font
# Requires spectrum.zsh
...
PROMPT='
$(_user_host)${_current_dir}$(git_prompt_info) $(ruby_prompt_info) $(nvm_prompt_info)
...
# nvm prompt
# we do not use the one provided with ohmyzsh as we have nvm through homebrew
# and it changes the way it detects if nvm is installed
...
# NVM prompt settings
ZSH_THEME_NVM_PROMPT_PREFIX="%{$FG[150]⬢ %}"
